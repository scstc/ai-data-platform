...
interface Props {
  open: boolean;
  jobId?: string;
  report?: DataPlatform.TrainsetReport;
  onClose: () => void;
}

const TrainsetReportModal: React.FC<Props> = ({
  open,
  jobId,
  report,
  onClose,
...
export default TrainsetReportModal;
