...
interface Props {
  open: boolean;
  jobId?: string;
  report?: DataPlatform.AugmentReport;
  onClose: () => void;
}

const AugmentReportModal: React.FC<Props> = ({
  open,
  jobId,
  report,
  onClose,
...
export default AugmentReportModal;
